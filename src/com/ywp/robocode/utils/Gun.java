...
public interface Gun {
	 ...
	 *
	 * @param target
	 *            - data to feed to gun for use later
	 */
	...
	/**
	 * Do any gun maintenance that is needed. For instance, go through the shots
	 * fired by this gun and expire the ones that are not needed. Update states
	 * if needed.
	 */
	void update();

	/**
	 * A bullet hit a bot. This provides the event information to the gun so it
	 * can update its stats if it was the owner of the shot. Note, code should
	 * expect events that do not belong to them.
	 *
	 * @param event
	 *            - The BulletHitEvent
	 */
	 ...
	 *
	 * @param target
	 *            - evaluate the guns validity against this target
	...
	/**
	 * This information is provided so that other code can decide which gun to
	 * use
	 *
